...
// Extracted ProjectCard into its own component
const ProjectCard = ({ project }) => (
  <div className="bg-gray-100 rounded-lg hover:scale-105 hover:bg-gray-300 transition duration-700 ease-in-out sm:w-full md:w-full lg:w-full h-74 p-4">
